...
final class Store: ObservableObject {
    ...
    private let fileName = "leaseline_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Unit One", detail: "First example entry.", date: now),
            Entry(title: "Sample Unit Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Unit Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
